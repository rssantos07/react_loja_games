  ...
  const form = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      email: Yup.string()
        ...
        .required('O campo é obrigatório'),
      cpf: Yup.string()
        .min(14, 'O campo precida ter 14 caracteres')
        .max(14, 'O campo precida ter 14 caracteres')
        .required('O campo é obrigatório'),
    ...
    <div className="container">
      {isSuccess && data ? (
        <Card title="Muito obrigado">
          <div>
            <p className="margin-top">
              Muito obrigado É com satisfação que informamos que recebemos seu
        ...
        <form onSubmit={form.handleSubmit}>
          <Card title="Dados de cobrança">
            <>
              ...
              <S.Row>
                ...
                <S.InputGroup>
                  <label htmlFor="confirmDeliveryEmail">Comfirme o email</label>
                  <input
                ...
                {payWithCard ? (
                  <>
                    ...
                    <S.Row marginTop="24px">
                      ...
                      <S.InputGroup>
                        <label htmlFor="cardNumber">Número cartão</label>
                        <InputMask
                          id="cardNumber"
                          type="text"
                          name="cardNumber"
          ...
          <Button
            type="submit"
            title="Cique aqui para finalizar a compra"
